...
const COLORS: Record<IconKind, string> = {
  ...
  tablesGroup: 'text-icon-folder',
  viewsGroup: 'text-icon-folder',
  functionsGroup: 'text-icon-folder',
  typesGroup: 'text-icon-folder',
  sequencesGroup: 'text-icon-folder',
  columnsGroup: 'text-icon-folder',
  indexesGroup: 'text-icon-folder',
  constraintsGroup: 'text-icon-folder',
  triggersGroup: 'text-icon-folder',
  extensionsGroup: 'text-icon-folder',
